...
const ParaphrasingMapView = () => {
  ...
  // Animal progression for paraphrasing
    ...
    try {
      const [testsResponse, progressResponse] = await Promise.all([
        supabase
          ...
          .eq('skill_slug', 'paraphrasing-challenge')
      ...
      toast.error('Failed to load paraphrasing map');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleNodeClick = (node: MapNode) => {
    navigate(`/skills/paraphrasing-challenge/test/${node.test.id}`);
  };
  ...
  const getNodeStyle = (status: string) => {
    switch (status) {
      ...
      case 'unlocked':
        return 'bg-gradient-to-br from-purple-400 to-pink-500 text-white shadow-lg border-purple-300 hover:shadow-xl transform hover:scale-105 cursor-pointer';
      default:
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <LottieLoadingAnimation size="lg" message="Loading your paraphrasing journey..." />
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <Card className="p-8 text-center">
          <CardContent>
            <p className="text-lg mb-4">Please sign in to access your paraphrasing journey.</p>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-4">
          <h1 className="text-4xl font-bold text-foreground mb-2">
            Paraphrasing Challenge Journey
          </h1>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            Do you want to unlock this level? This will allow you to start the {getAnimalForLevel(index).name} paraphrasing challenge.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
...
export default ParaphrasingMapView;