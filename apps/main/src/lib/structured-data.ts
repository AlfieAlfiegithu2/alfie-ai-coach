...
export const createOrganizationSchema = () => ({
  ...
  "name": "English AIdol",
  "alternateName": ["English AI dol", "EnglishAI", "English Idol AI", "English AIdol", "AIdol English"],
  ...
  "foundingDate": "2024",
  "slogan": "AI-Powered English Learning Platform | English AIdol",
  "knowsAbout": [
    "IELTS Preparation",
...
export const createWebSiteSchema = () => ({
  ...
  "@type": "WebSite",
  "name": "English AIdol",
  "alternateName": ["English AI dol", "English AIdol", "EnglishAI", "EnglishIdol"],
