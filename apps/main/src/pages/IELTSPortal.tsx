            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
                {IELTS_SKILLS.map((skill, index) => {
                  ...
                  return (
                    <SpotlightCard key={skill.id} className="cursor-pointer min-h-[140px] hover:scale-105 transition-all duration-300 hover:shadow-lg" onClick={() => handleSkillClick(skill.id)}>
