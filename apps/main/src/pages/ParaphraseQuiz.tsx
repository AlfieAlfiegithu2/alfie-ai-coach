...
const ParaphraseQuiz = () => {
  ...
  useEffect(() => { document.title = "Paraphrasing Challenge | Quiz"; }, []);

  return (
    <StudentLayout title="Paraphrasing Challenge" showBackButton>
            ...
            <div className="relative">
              ...
              >
                <img
                  ...
                  alt="Quiz progress turtle mascot"
            ...
            <Card className="w-full max-w-3xl md:max-w-4xl lg:max-w-5xl">
              <CardContent className="p-6 space-y-4">
                ...
                <div className="flex gap-2 justify-center">
                  ...
                  <Button variant="secondary" onClick={() => navigate("/skills/paraphrasing-challenge")}>Back</Button>
                </div>
              </CardContent>
            </Card>
          ) : (
