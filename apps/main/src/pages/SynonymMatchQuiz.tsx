...
const SynonymMatchQuiz = () => {
    ...
    return (
        <StudentLayout title="Synonym Match" showBackButton>
                ...
                <div className="min-h-[70vh] flex flex-col items-center justify-center gap-4">
                        ...
                        <div className="relative">
                            ...
                            >
                                <img
                                    ...
                                    alt="Synonym match progress turtle mascot"
                    ...
                    {!finished && (
                        <div className="w-full max-w-3xl md:max-w-4xl lg:max-w-5xl flex justify-end -mt-2">
                            <Button variant="outline" onClick={() => navigate('/skills/synonym-match')}>Quit to Map</Button>
                        </div>
                    )}
                        ...
                        <Card className="w-full max-w-3xl md:max-w-4xl lg:max-w-5xl">
                            <CardContent className="p-6 space-y-4">
                                ...
                                <div className="flex gap-2 justify-center">
                                    ...
                                    <Button variant="secondary" onClick={() => navigate("/skills/synonym-match")}>Back to Map</Button>
                                </div>
                            </CardContent>
                        </Card>
                    ) : (
...
export default SynonymMatchQuiz;
