      ...
      <div className="container mx-auto px-4 py-4 max-w-6xl">
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">TOEIC Reading Test</p>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          {/* Question Panel */}
          <Card className={`${(currentPart?.partNumber === 6 || currentPart?.partNumber === 7) && (currentPassage || currentQuestion?.passage_context) ? '' : 'md:col-span-2'}`}>
            <CardHeader>
                          ...
                          return (
                            <Label
                              ...
                              className={`flex items-center gap-3 p-4 rounded-lg border cursor-pointer transition-all ${
                                isCorrect ? 'bg-green-50 border-green-300 dark:bg-green-950/20' :
                                isWrong ? 'bg-red-50 border-red-300 dark:bg-red-950/20' :
                                isSelected ? 'bg-green-50 border-green-300 dark:bg-green-950/20' :
                ...
                return (
                  <Button
                    ...
                    className={`w-10 h-10 p-0 ${
                      ...
                      isCurrent ? 'bg-green-100 border-green-300' :
