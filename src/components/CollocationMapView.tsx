  ...
  const loadMapData = async () => {
    ...
    try {
      const testsResponse = await supabase
        ...
        .eq('skill_slug', 'collocation-connect')
      ...
      toast.error('Failed to load collocation connect data');
    } finally {
      setLoading(false);
    }
  };
  ...
  if (!user) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <Card className="p-8 text-center">
          <CardContent>
            <p className="text-lg mb-4">Please sign in to access collocation connect.</p>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  We're working hard to bring you an amazing Collocation Connect experience!
                </p>
                <p className="text-sm text-muted-foreground">
                  This feature will help you master word collocations and natural language patterns.
                </p>
              </div>
            </div>
          </CardContent>
...
export default CollocationMapView;