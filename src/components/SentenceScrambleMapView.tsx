...
const SentenceScrambleMapView = () => {
  ...
  // Animal progression for sentence structure
  ...
  const loadMapData = async () => {
    ...
    try {
      ...
      toast.error('Failed to load sentence scramble map');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleNodeClick = (node: MapNode) => {
    navigate(`/skills/sentence-structure-scramble/test/${node.test.id}`);
  };
  ...
  const getNodeStyle = (status: string) => {
    switch (status) {
      ...
      case 'unlocked':
        return 'bg-gradient-to-br from-indigo-400 to-blue-500 text-white shadow-lg border-indigo-300 hover:shadow-xl transform hover:scale-105 cursor-pointer';
      default:
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <LottieLoadingAnimation size="lg" message="Loading your sentence scramble journey..." />
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <Card className="p-8 text-center">
          <CardContent>
            <p className="text-lg mb-4">Please sign in to access your sentence scramble journey.</p>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-4">
          <h1 className="text-4xl font-bold text-foreground mb-2">
            Sentence Structure Scramble Journey
          </h1>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            Do you want to unlock this level? This will allow you to start the {getAnimalForLevel(index).name} sentence scramble challenge.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
...
export default SentenceScrambleMapView;