...
import GrammarCSVImport from "@/components/GrammarCSVImport";
...
const AdminGrammarTestDetail = () => {
  ...
  return (
    <AdminLayout title={test ? `Manage: ${test.title}` : "Manage Grammar Test"} showBackButton>
      <section className="space-y-6">
        {id && (
          <GrammarCSVImport skillTestId={id} onImported={load} />
        )}
...
export default AdminGrammarTestDetail;
