...
const AdminSentenceScrambleTestDetail = () => {
  ...
  const saveEdit = async () => {
    ...
    const { error } = await (supabase as any)
      ...
      .update({
        content: form.content || "Unscramble the sentence.",
        question_format: form.question_format || "SentenceScramble",
  ...
  return (
    <AdminLayout title={test ? `Manage: ${test.title}` : "Manage Sentence Scramble Test"} showBackButton>
      <section className="space-y-6">
        {id && (
          <SentenceScrambleCSVImport skillTestId={id} onImported={load} />
        )}
        ...
        <Dialog open={!!editing} onOpenChange={(o) => { if (!o) setEditing(null); }}>
          <DialogContent className="sm:max-w-lg">
            ...
            <div className="space-y-3">
              ...
              <div>
                <Label htmlFor="correct_answer">Chunk 1 (first)</Label>
...
export default AdminSentenceScrambleTestDetail;
