...
const AdminWriting = () => {
  ...
  const handleCreate = async (e) => {
    e.preventDefault();
    try {
      await createContent('writing_prompts', formData);
      toast({
        title: "Success",
  ...
  const handleDelete = async (id) => {
    if (confirm("Are you sure you want to delete this prompt?")) {
      try {
        await deleteContent('writing_prompts', id);
        toast({
          title: "Success",
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        {showCreateForm && (
          <Card className="mb-6">
            <CardHeader>
              <CardTitle>Create New Writing Prompt</CardTitle>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleCreate} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Input
                    ...
                    onChange={(e) => setFormData({...formData, task_number: parseInt(e.target.value)})}
                  />
            ...
            <Card key={prompt.id}>
              ...
              <CardContent>
                <div className="flex gap-4 text-sm text-muted-foreground mb-2">
                  ...
                  <span>Type: {prompt.task_type}</span>
