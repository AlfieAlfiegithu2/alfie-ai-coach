...
const Dashboard = () => {
  ...
  const sections = [
    { id: "listening", name: "听力", icon: Headphones, color: "bg-blue-500" },
    { id: "reading", name: "阅读", icon: BookOpen, color: "bg-green-500" },
    { id: "writing", name: "写作", icon: PenTool, color: "bg-purple-500" },
    { id: "speaking", name: "口语", icon: Mic, color: "bg-orange-500" }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white">
      <div className="container mx-auto px-4 py-8">
                  ...
                  >
                    <CardContent className="p-6">
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-sm text-gray-600">听 说 读 写</div>
                      </div>
                    </CardContent>
                  </Card>
                ))}
        ...
        <div className="mt-12 text-center">
          <h3 className="text-xl font-semibold mb-6 text-gray-700">或选择单项练习</h3>
