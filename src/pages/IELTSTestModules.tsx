        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {modules.map(module => {
                ...
                return <Card key={module.id} className={`backdrop-blur-xl hover:scale-105 transition-all duration-300 ${module.borderColor} ${module.bgColor} rounded-2xl`}>
                  <CardHeader className="text-center pb-4">
                    ...
                    <CardTitle className="text-xl flex items-center justify-center gap-2 text-white">
                      {module.name}
                      {isAvailable && <Badge variant="default" className="text-xs bg-green-600 text-white">Available</Badge>}
                      {!isAvailable && <Badge variant="secondary" className="text-xs bg-gray-600 text-white">Coming Soon</Badge>}
                    </CardTitle>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Button onClick={() => handleModuleSelect(module.id)} className={`w-full text-white ${isAvailable ? module.buttonColor : 'bg-gray-400 cursor-not-allowed'}`} size="sm" disabled={!isAvailable}>
