          ...
          <CardContent className="space-y-6">
            <div className="bg-blue-light/30 p-6 rounded-lg">
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                <li>• Task 1: Describe visual information (150 words minimum)</li>
                <li>• Task 2: Write an essay in response to an argument (250 words minimum)</li>
                <li>• Task 2 carries more weight in marking</li>
                <li>• You may write in pen or pencil</li>
              </ul>
            </div>
            
            <div className="text-center py-12">
              <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-blue-light flex items-center justify-center">
                <PenTool className="w-12 h-12 text-blue-deep" />
              </div>
              <h2 className="text-xl font-semibold mb-4">Writing Test Coming Soon</h2>
              <p className="text-muted-foreground mb-6">
                We're developing AI-powered writing assessment with detailed feedback on grammar, coherence, and task response
              </p>
              <Button variant="hero">
